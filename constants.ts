...
export const TEAMS_DATA: Team[] = [
  ...
  { id: 2, name: '斯巴達增肌減脂戰士', gender: 'female', points: 0.0, members: ['謝家芸', '翁憶如'], weekly: [2,2], bonusW2: 4, bonusW8: -1},
  { id: 3, name: '聿罷不寧', gender: 'female', points: 0.0, members: ['彭聿采', '許家寧'], weekly: [2,2], bonusW2: 4, bonusW8: -1},
  { id: 4, name: '吱吱唧唧嘰吱', gender: 'female', points: 0.0, members: ['劉凡瑀', '施捷如'], weekly: [1,2], bonusW2: 4, bonusW8: -1},
  { id: 5, name: '我們只是胖著玩玩', gender: 'female', points: 0.0, members: ['詹壬菡', '林玉涵'], weekly: [1,1], bonusW2: 4, bonusW8: -1},
  { id: 6, name: '瘦到你認不出我隊', gender: 'female', points: 0.0, members: ['林雅茹', '張翊琳'], weekly: [2,2], bonusW2: 4, bonusW8: -1},
  { id: 7, name: '我胖我驕傲', gender: 'female', points: 0.0, members: ['杜巧琍', '蔡佳玲'], weekly: [2,2], bonusW2: 4, bonusW8: -1},
  { id: 8, name: '總是志在參加', gender: 'female', points: 0.0, members: ['陳玥年', '黃孟淳'], weekly: [2,2], bonusW2: 4, bonusW8: -1},
  { id: 9, name: '祐要運動到嫣嫣一息ㄌ', gender: 'female', points: 0.0, members: ['蘇祐萱', '李嫣容'], weekly: [2,2], bonusW2: 4, bonusW8: -1},
  { id: 10, name: 'GK動態提脂', gender: 'female', points: 0.0, members: ['林怡汝', '游季婕'], weekly: [2,2], bonusW2: 4, bonusW8: -1},
  { id: 11, name: '媽媽帶女兒', gender: 'female', points: 0.0, members: ['沈惟鉦', '莊壹淋'], weekly: [2,2], bonusW2: 4, bonusW8: -1},
  { id: 12, name: '為什麼吃東西會胖呢', gender: 'female', points: 0.0, members: ['黃婕瑀', '徐瑞妤'], weekly: [2,1], bonusW2: 3, bonusW8: -1},
  { id: 13, name: 'Luna 的快樂小夥伴', gender: 'female', points: 0.0, members: ['連英茹', '周品均'], weekly: [1,1], bonusW2: 2, bonusW8: -1},
  ...
  { id: 19, name: '.', gender: 'male', points: 0.0, members: ['江東儒', '蔣皓丞'], weekly: [2,2], bonusW2: 4, bonusW8: -1},
  { id: 20, name: '路過', gender: 'male', points: 0.0, members: ['曾奐嘉', '吳省澤'], weekly: [1,1], bonusW2: 3, bonusW8: -1},
  { id: 21, name: '禎的有廖', gender: 'male', points: 0.0, members: ['張宜禎', '廖偉丞'], weekly: [1,1], bonusW2: 2, bonusW8: -1},
